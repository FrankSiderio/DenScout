...
@section('content')
  ...
  <div class="row">
    <div class="input-field col s12 recommendations-search">
          ...
          <div class="recommendations-searchbutton">
            <a class="waves-effect waves-light btn recommendations-search-button"> <i class="material-icons">question_answer</i></a>
          </div>
    </div>
  </div>
